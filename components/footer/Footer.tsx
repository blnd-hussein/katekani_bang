...
function Footer() {
  ...
  return (
    <footer className="flex justify-center items-center bg-base-100/30 w-2/3 mx-auto backdrop-blur-xs gap-5 -mt-3 rounded-tr-full rounded-bl-full p-1">
      ...
      <button
        className="btn btn-outline group hover:bg-transparent hover:border-neutral-content backdrop-blur-xs h-full rounded-full py-4"
      ...
      >
        <svg
          ...
          id="_x32_"
          viewBox="0 0 512 512"
          className="h-12 w-12 fill-neutral-content/90 group-hover:scale-105 transition-transform"
        >
