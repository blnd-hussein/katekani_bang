...
function Footer() {
  ...
  return (
    <footer className="flex justify-center items-center bg-base-100/30 w-2/3 mx-auto backdrop-blur-xs gap-4.5 -mt-2 rounded-full p-1 h-20">
      ...
      <button
        className="btn btn-ghost shadow-none border-none outline-none group hover:bg-transparent h-full"
      ...
      >
        <svg
          ...
          id="_x32_"
          viewBox="0 0 512 512"
          className="h-15 w-15 fill-neutral-content/90 group-hover:scale-105 transition-transform outline-1 p-2 rounded-full rotate-22"
        >
